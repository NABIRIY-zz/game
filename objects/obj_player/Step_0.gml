...
if(sprite_index == hero_dead) image_speed = freezDamage*300/hp //Анимация заморозки синхронизированная с колличеством ХП???
if(!Move)
{
	sprite_index = hero_dead;
	if(hp <= 20) image_index = 9;
